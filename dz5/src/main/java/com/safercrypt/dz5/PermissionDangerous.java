...
/**
 * Created by pavelsafronov on 08.12.16.
 * данный клас был создал для показания как можно получить доступы из программы после 23версии
 */

public class PermissionDangerous extends AppCompatActivity {
